(() => {
  ...
  function managedPageId(product) {
  ...
  function latestProductFile(data, product) {
  ...
  function productTargetBadge(data, product) {
  ...
  function productVersionBadge(data, product) {
